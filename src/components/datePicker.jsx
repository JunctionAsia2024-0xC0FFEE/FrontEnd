...
function Select({ options, selectedOption, setSelectedOption, showDropdown, setShowDropdown }) {
	return (
		<div className="justify-start items-center flex relative bg-box rounded-md p-2 gap-1 transition-all duration-700 active:scale-95" onClick={setShowDropdown}>
